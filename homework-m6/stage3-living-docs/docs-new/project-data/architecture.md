...
> **TODO(audit-2026-05-28):** Architecture document predates feature flags system and MCP servers. Add sections for `features.json` architecture and `mcp-docs-search` / `mcp-feature-flags` integrations.
