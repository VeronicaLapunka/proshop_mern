...
server.registerTool("search_project_docs", {
    description: `
...
`.trim(),
    inputSchema: {
        query: z
            .string()
            .min(1)
            .describe("Natural-language search query. Be specific — include entity names, " +
        ...
        top_k: z
            ...
            .max(20)
            .default(5)
            .describe("Number of chunks to return (1–20, default 5). Use 3 for precise " +
